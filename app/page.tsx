  ...
  return (
    <>
      ...
      <main className="flex-1">
        {/* ===== HERO SECTION ===== */}
        <header className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-gradient-to-br from-surface to-primary-container/10">
          <div className="max-w-7xl mx-auto px-6 md:px-8 w-full editorial-grid gap-8">
            ...
            <div className="col-span-12 lg:col-span-7 flex flex-col justify-center">
              ...
              <ScrollReveal delay={500}>
                <div className="flex flex-wrap gap-4 items-center">
                  <Link
                    href="/contact"
                    className="bg-primary text-on-primary px-10 py-4 rounded-xl text-lg font-semibold flex items-center group transition-all duration-300 hover:shadow-xl hover:shadow-primary/20 hover:gap-4 hover-ripple active:scale-95"
                  >
                    Start Your Journey
              ...
              <ScrollReveal delay={650}>
                <div className="mt-16 flex gap-8 items-center border-t border-outline-variant/20 pt-8">
                  {[
            ...
            <div className="col-span-12 lg:col-span-5 relative mt-12 lg:mt-0">
              <ScrollReveal variant="scale" delay={300}>
                <div className="aspect-[4/5] rounded-full overflow-hidden border-[12px] border-surface-container-low shadow-2xl relative z-10 hover-zoom-img animate-pulse-glow">
                  {/* Desktop hero image */}
                  <Image
                    src={IMAGES.hero}
        ...
        <section className="py-24 bg-surface">
          <div className="max-w-7xl mx-auto px-6 md:px-8">
            <ScrollReveal>
              <div className="mb-16">
                <h2 className="font-headline text-4xl text-primary mb-4">Core Expertise</h2>
            ...
            <div className="md:hidden">
              <ScrollReveal>
                <div className="flex overflow-x-auto pb-8 gap-6 no-scrollbar -mx-6 px-6">
                  {[
                    {
                      img: IMAGES.skincare,
        ...
        <section className="py-24 bg-surface-container-low overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 md:px-8">
            <div className="editorial-grid gap-16 items-center">
              {/* Image Grid */}
              <div className="col-span-12 lg:col-span-6 relative">
                <div className="grid grid-cols-2 gap-4">
                  <ScrollReveal variant="left" delay={100}>
                    <div className="rounded-xl w-full h-64 overflow-hidden shadow-lg hover-zoom-img hover-lift">
                      <Image
                        src={IMAGES.clinic}
                  ...
                  <ScrollReveal variant="right" delay={300}>
                    <div className="rounded-xl w-full h-64 overflow-hidden mt-12 shadow-lg hover-zoom-img hover-lift">
                      <Image
                        src={IMAGES.doctor}
                  ...
                  {careSteps.map((step, index) => (
                    <ScrollReveal key={step.step} delay={200 + index * 200}>
                      <div className="flex gap-6 group cursor-default">
                        <div className="flex-shrink-0 w-12 h-12 rounded-full border border-primary flex items-center justify-center font-headline text-xl text-primary group-hover:bg-primary group-hover:text-white transition-all duration-500 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-primary/20">
                          {step.step}
                        </div>
                        <div>
                          <h4 className="font-headline text-xl text-primary mb-2 group-hover:translate-x-1 transition-transform duration-300">
                            {step.title}
                          </h4>
        ...
        <section className="py-24 bg-white overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 md:px-8 text-center">
            ...
            <ScrollReveal delay={200}>
              <p className="font-headline text-2xl md:text-3xl text-primary max-w-4xl mx-auto leading-relaxed mb-8 italic">
        ...
        <section className="py-20 bg-primary-container relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10 text-center">
            <ScrollReveal>
              <h2 className="font-headline text-4xl md:text-5xl text-white mb-8">
            ...
            <ScrollReveal delay={400}>
              <Link
                href="/contact"
                className="inline-flex items-center justify-center bg-secondary-container text-on-secondary-container px-12 py-5 rounded-full text-xl font-bold hover:bg-white hover:text-primary transition-all duration-500 shadow-xl active:scale-95 hover:shadow-2xl hover:shadow-white/20 group"
              >
